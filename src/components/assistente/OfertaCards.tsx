      ...
      >
        ...
        <div className="flex items-start gap-2.5">
          ...
          {cat.combo?.linkImgAlbum && (
            <img src={cat.combo.linkImgAlbum} alt="" className={`mt-px h-[54px] w-[54px] shrink-0 rounded-[10px] object-cover shadow ${c.colecao ? 'outline outline-2 outline-[#3FA744]' : ''}`} />
          )}
        ...
        return (
          ...
          >
            <div className={`flex items-start gap-2.5 ${off ? 'opacity-50' : ''}`}>
              <Check on={sel} />
              {b.linkImgAlbum && (
                <img src={b.linkImgAlbum} alt="" className={`mt-px h-[54px] w-[54px] shrink-0 rounded-[10px] object-cover shadow ${sel ? 'outline outline-2 outline-[#3FA744]' : ''}`} />
              )}
              <div className="flex-1">
