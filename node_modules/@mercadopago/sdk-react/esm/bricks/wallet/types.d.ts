...
interface IWalletBrickBaseCustomization {
    ...
    */
     ...
     */
    valueProp?: 'practicality' | 'convenience' | 'convenience_all' | 'security_details' | 'security_safety' | 'convenience_credits' | 'payment_methods_logos' | 'free_shipping' | 'ml_shipping';
    /**
