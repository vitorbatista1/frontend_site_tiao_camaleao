...
const ExpirationYear = (params) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        let timer;
        timer = setTimeout(() => {
            (0, util_1.initSecureField)('expirationYear', params)
    ...
    return react_1.default.createElement("div", { id: "expirationYearSecureField_container" });
};
exports.default = ExpirationYear;
