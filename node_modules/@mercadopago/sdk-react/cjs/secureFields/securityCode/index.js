...
const SecurityCode = (params) => {
    const initializationDependencies = (0, util_1.getInitializationDependencies)(params, ['placeholder', 'length', 'mode']);
    (0, react_1.useEffect)(() => {
        // SecureField uses a debounce to prevent unnecessary reRenders.
        let timer;
        timer = setTimeout(() => {
            (0, util_1.initSecureField)('securityCode', params)
    ...
    return react_1.default.createElement("div", { id: "securityCodeSecureField_container" });
};
