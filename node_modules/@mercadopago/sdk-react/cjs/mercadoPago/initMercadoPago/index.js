...
exports.MercadoPagoInstance = void 0;
const sdk_js_1 = require("@mercadopago/sdk-js");
class MercadoPagoInstance {
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.publicKey) {
                if (!this.loadedInstanceMercadoPago) {
                    yield (0, sdk_js_1.loadMercadoPago)();
...
exports.MercadoPagoInstance = MercadoPagoInstance;
...
exports.default = initMercadoPago;
